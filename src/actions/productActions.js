...
import {
  ...
  export const newProduct = (productData) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.post(`${process.env.REACT_APP_API}/api/v1/admin/product/new`, productData,{withCredentials:true}, config  )
  ...
  export const updateProduct = (id, productData) => async (dispatch) => {
    ...
    try {
        ...
        const { data } = await axios.put(`${process.env.REACT_APP_API}/api/v1/admin/product/${id}`, productData,{withCredentials:true}, config,)
  ...
  // }
    ...
    try {
        ...
        const { data } = await axios.put(`${process.env.REACT_APP_API}/api/v1/review`, reviewData,{withCredentials:true}, config)
